...
const Cart = () => {
  ...
  const minusCartItem = React.useCallback(id => dispatch(cartActions.minusItem(id)), [dispatch]);
  ...
  const removeItemsById = React.useCallback(
    id => {
      if (window.confirm('Ви дійсно хочете видалити піццу з кошика?')) {
  ...
  return (
    <div className="container container--cart">
      <div className={classNames('cart', { 'cart--empty': !itemsCount })}>
        {itemsCount ? (
          <React.Fragment>
